...
function UF.UpdateFrame(frame)
    ...
    healthBarTexture:SetHorizTile(dbEntryUF.HealthBar.HorizTiling)
    healthBarTexture:SetVertTile(dbEntryUF.HealthBar.VertTiling)

    frame.Background:SetTexture(dbEntryUF.HealthBar.Texture)
    frame.Background:SetHorizTile(dbEntryUF.HealthBar.HorizTiling)
    frame.Background:SetVertTile(dbEntryUF.HealthBar.VertTiling)
    ...
    healPredictionTexture:SetHorizTile(dbEntryUF.HealthBar.HorizTiling)
    healPredictionTexture:SetVertTile(dbEntryUF.HealthBar.VertTiling)

    local damageAbsorbTexture = frame.DamageAbsorbBar:GetStatusBarTexture()
    damageAbsorbTexture:SetTexture(dbEntryUF.DamageAbsorbBar.Texture, "REPEAT", "REPEAT")
    damageAbsorbTexture:SetHorizTile(dbEntryUF.DamageAbsorbBar.HorizTiling)
    damageAbsorbTexture:SetVertTile(dbEntryUF.DamageAbsorbBar.VertTiling)

    local healAbsorbTexture = frame.HealAbsorbBar:GetStatusBarTexture()
    healAbsorbTexture:SetTexture(dbEntryUF.HealAbsorbBar.Texture, "REPEAT", "REPEAT")
    healAbsorbTexture:SetHorizTile(dbEntryUF.HealAbsorbBar.HorizTiling)
    healAbsorbTexture:SetVertTile(dbEntryUF.HealAbsorbBar.VertTiling)
...
function SetupUnitFrame(frameName, unit, number)
    ...
    damageAbsorbBar:SetFrameLevel(healPredictionBar:GetFrameLevel()+1)
    ...
    healAbsorbBar:SetFrameLevel(damageAbsorbBar:GetFrameLevel()+1)
